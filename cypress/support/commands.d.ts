...
declare namespace Cypress {
	interface Chainable<Subject = any> {
		 ...
		 */
		googleHomeInterceptors(): Cypress.Chainable<
			readonly ['@loadFinishedRequest']
		>
		 ...
		 * @returns {Cypress.Chainable<readonly ['@loadFinishedRequest']>} Chainable containing the alias for the finished request.
		 */
		gmailHomeInterceptors(): Cypress.Chainable<
			readonly ['@loadFinishedRequest']
		>
		/**
		 ...
		 * @returns {Cypress.Chainable<readonly ['@loadFinishedRequest']>} Chainable containing the alias for the finished request.
		 */
		googleImagesHomeInterceptors(): Cypress.Chainable<
			readonly ['@loadFinishedRequest']
		>
